...
public class NonTargetMultiProjectileSkillTemplate : SkillTemplate
{
    ...
    public override void Apply(Entity caster, int skillLevel)
    {
        ...
        if (projectile != null)
        {
            ...
            Debug.Log("NonTargetMulti effect gap : " + gap);
            ...
            for (int i = 0; i < projectileCount.Get(skillLevel); i++)
                {
                    ...
                    GameObject go = Instantiate(projectile.gameObject, 
                        caster.GetEffectMount(projtileEffectMount[i % projtileEffectMount.Length]).position, 
                        caster.GetEffectMount(projtileEffectMount[i % projtileEffectMount.Length]).rotation);
